...
class OrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PlaceOrder = channel.unary_unary(
                ...
                request_serializer=order__pb2.PlaceOrderRequest.SerializeToString,
                response_deserializer=order__pb2.PlaceOrderResponse.FromString,
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'PlaceOrder': grpc.unary_unary_rpc_method_handler(
                    servicer.PlaceOrder,
                    request_deserializer=order__pb2.PlaceOrderRequest.FromString,
                    response_serializer=order__pb2.PlaceOrderResponse.SerializeToString,
            ),
...
class OrderService(object):
    ...
    def PlaceOrder(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/order.OrderService/PlaceOrder',
            order__pb2.PlaceOrderRequest.SerializeToString,
            order__pb2.PlaceOrderResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
